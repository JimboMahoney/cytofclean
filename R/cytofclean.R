...
tkgrid(tklabel(tt, text = ""),tklabel(tt, text = ""),tklabel(tt, text = "Version: 0.6 beta"))
...
if (tclvalue(ret_var) != "OK") {
  ...
  #plot(Event_Density[[1]]$x, Event_Density[[1]]$y)
  ...
  #plot(Centre_Density[[1]]$x, Centre_Density[[1]]$y)
  ...
  #plot(Width_Density[[1]]$x, Width_Density[[1]]$y)
  ...
  #plot(Eu151Di$x,Eu151Di$y, log="y")
  #plot(Eu153Di$x,Eu153Di$y, log="y")
  #plot(Ho165Di$x,Ho165Di$y, log="y")
  #plot(Lu175Di$x,Lu175Di$y, log="y")
